    ...
    public function paintFooter($result) {
        ...
        if (isset($this->params['codeCoverage']) && $this->params['codeCoverage']) {
            ...
            if (method_exists($coverage, 'getSummary')) {
                $report = call_user_func_array(array($coverage, 'getSummary'), array());
 ...
 */
    public function paintFail($message, $test) {
        ...
        if (method_exists($message, 'getComparisonFailure')) {
            $failure = call_user_func_array(array($message, 'getComparisonFailure'), array());
 ...
 * top level test.
 *
 * @param mixed $test Test method that just passed
 * @param float $time time spent to run the test method
 * @return void
 */
    public function paintPass($test, $time = null) {
        ob_start();
 ...
 *
 * @param mixed $message Text of skip condition.
 ...
 * A test ended.
 *
 * @param PHPUnit_Framework_TestCase $test The test that ended
 * @param float $time The current time.
 * @return void
 */
