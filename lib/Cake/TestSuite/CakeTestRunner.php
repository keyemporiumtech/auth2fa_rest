...
if (class_exists('CodeCoverage\CodeCoverage')) {
    class_alias('CodeCoverage\CodeCoverage', 'PHP_CodeCoverage');
    class_alias('CodeCoverage\Report\Text', 'PHP_CodeCoverage_Report_Text');
    class_alias('CodeCoverage\Report\PHP', 'PHP_CodeCoverage_Report_PHP');
    class_alias('CodeCoverage\Report\Clover', 'PHP_CodeCoverage_Report_Clover');
    class_alias('CodeCoverage\Report\Html\Facade', 'PHP_CodeCoverage_Report_HTML');
    class_alias('CodeCoverage\Exception', 'PHP_CodeCoverage_Exception');
}
 ...
 *
 * @param PHPUnit_Framework_TestSuite $suite The test suite to run
    ...
    protected function createTestResult() {
        ...
        if (!empty($this->_params['codeCoverage'])) {
            if (method_exists($result, 'collectCodeCoverageInformation')) {
                call_user_func_array(array($result, 'collectCodeCoverageInformation'), array(true));
