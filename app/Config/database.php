...
class DATABASE_CONFIG {
	public $default= array (
			'datasource' => 'MysqlNoConstraints',
			'persistent' => false,
			'host' => 'localhost',
			'login' => 'root',
			'password' => '',
			'database' => 'mod_rest_base',
			'prefix' => '',
			'encoding' => 'utf8' 
	);
	public $test= array (
			...
			'login' => 'root',
			'password' => '',
			'database' => 'mod_rest_base_test',
			'prefix' => '',
			'encoding' => 'utf8' 
	);

	function __construct() {
		$this->default ['database']= Defaults::get("db_name");
		$this->default ['host']= Defaults::get("db_host");
		$this->default ['login']= Defaults::get("db_user");
		$this->default ['password']= Defaults::get("db_password");
	}
}
