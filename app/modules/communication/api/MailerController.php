...
class MailerController extends AppController {
     ...
     * @OA\Get(
     *     path="/mailer/get",
     *     summary="Legge un provider di email",
     *     description="Ritorna un provider di email per uno specifico id o per codice",
     *     operationId="mailer-get",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del provider di email",
     *         in="query",
     *         name="id_mailer",
     *         required=false,
     ...
     *     ),
     *     @OA\Parameter(
     *         description="codice del provider di email",
     *         in="query",
     *         name="mailer_codice",
     *         required=false,
     ...
     * )
     */
    public function get($id_mailer = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_mailer, 'id_mailer');
        parent::evalParam($cod, 'cod');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_mailer, $cod));
     ...
     * @OA\Get(
     *     path="/mailer/table",
     *     summary="Legge una lista paginata di provider di emaii",
     *     description="Ritorna una lista di provider di emaii filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="mailer-table",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     *         @OA\Schema(
     *             type="array",
     *             @OA\Items(ref="#/components/schemas/Mailer")
     *         )
     *     ),
     *     @OA\Response(
     *         response="default",
     ...
     * @OA\Post(
     *     path="/mailer/save",
     *     summary="Salva un provider di email",
     *     description="Salva un provider di email ne ritorna l'id",
     *     operationId="mailer-save",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto provider di email",
     *         request="mailer",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Mailer")
     *     ),
     ...
     * )
     */
    public function save($mailerJson = null, $groupssave = null) {
        parent::evalParam($mailerJson, "mailer");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($mailerJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Put(
     *     path="/mailer/edit",
     *     summary="Modifica un provider di email",
     *     description="Modifica un provider di email ne ritorna l'id",
     ...
     * )
     */
    public function edit($id_mailer = null, $mailerJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_mailer, "id_mailer");
        parent::evalParam($mailerJson, "mailer");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_mailer, $mailerJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Delete(
     *     path="/mailer/delete",
     *     summary="Rimuove un provider di email",
     *     description="Rimuove un provider di email dato l'id",
     *     operationId="mailer-delete",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del provider di email da eliminare",
     *         in="query",
     *         name="id_mailer",
     *         required=true,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function delete($id_mailer = null) {
        parent::evalParam($id_mailer, "id_mailer");
        $this->set('flag', $this->delegate->delete($id_mailer));
        $this->responseMessageStatus($this->delegate->status);
    }
}
