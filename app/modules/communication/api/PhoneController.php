...
class PhoneController extends AppController {
     ...
     * @OA\Get(
     *     path="/phone/get",
     *     summary="Legge un messaggio",
     *     description="Ritorna un messaggio per uno specifico id",
     *     operationId="phone-get",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * )
     */
    public function get($id_phone = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_phone, 'id_phone');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_phone));
     ...
     * @OA\Get(
     *     path="/phone/table",
     *     summary="Legge una lista paginata di messaggi",
     *     description="Ritorna una lista di messaggi filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="phone-table",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/phone/save",
     *     summary="Salva un messaggio",
     *     description="Salva un messaggio ne ritorna l'id",
     *     operationId="phone-save",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto messaggio",
     *         request="phone",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Phone")
     *     ),
     ...
     * )
     */
    public function save($phoneJson = null, $groupssave = null) {
        parent::evalParam($phoneJson, "phone");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($phoneJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     description="Modifica un messaggio ne ritorna l'id",
     *     operationId="phone-edit",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto messaggio",
     ...
     * )
     */
    public function edit($id_phone = null, $phoneJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_phone, "id_phone");
        parent::evalParam($phoneJson, "phone");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_phone, $phoneJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Delete(
     *     path="/phone/delete",
     *     summary="Rimuove un messaggio",
     *     description="Rimuove un messaggio dato l'id",
     ...
     * )
     */
    public function delete($id_phone = null) {
        parent::evalParam($id_phone, "id_phone");
        $this->set('flag', $this->delegate->delete($id_phone));
        $this->responseMessageStatus($this->delegate->status);
    }
    // ------------------------ PLUGIN INTERACTION
    /**
     ...
     *     description="Invia un messaggio ad un cellulare ne ritorna l'esito",
     *     operationId="phone-send",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     ...
     *         request="sender",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/PhoneUser")
     *     ),
     *     @OA\Parameter(
     *         description="Lista dei destinatari del messaggio",
     *         in="query",
     *         name="destinators",
     *         required=true,
     *         @OA\Schema(
     *                 type="array",
     *                   @OA\Items(ref="#/components/schemas/PhoneUser")
     *           )
     *     ),
     *     @OA\Parameter(
     *         description="body o messaggio formato testo",
     *         in="query",
     *         name="message",
     *         required=true,
     *         @OA\Schema(type="string")
     ...
     * )
     */
    public function send($sender = null, $destinators = null, $body = null) {
        parent::evalParam($sender, "sender");
        parent::evalParam($destinators, "destinators");
        parent::evalParam($body, "message");
        $this->set('flag', $this->delegate->send($sender, $destinators, $body));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Get(
     *     path="/phone/getRead",
     *     summary="Legge una messaggio con i dettagli",
     *     description="Ritorna un messaggio per uno specifico id e i destinatari",
     *     operationId="phone-getRead",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del messaggio",
     ...
     * )
     */
    public function getRead($id_phone = null) {
        parent::evalParam($id_phone, 'id_phone');
        $this->set('data', $this->delegate->getRead($id_phone));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Get(
     *     path="/phone/tableRead",
     *     summary="Legge una lista paginata di messaggi con dettaglio",
     *     description="Ritorna una lista di messaggi dettagliati (con destinatari) filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="phone-tableRead",
     *     tags={"communication"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="Lista delle condizioni di filtro",
