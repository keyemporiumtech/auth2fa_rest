...
class CategoryController extends AppController {
     ...
     * @OA\Get(
     *     path="/category/get",
     *     summary="Legge una categoria",
     *     description="Ritorna una categoria per uno specifico id o per codice o per nome",
     ...
     * )
     */
    public function get($id_category = null, $cod = null, $name = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_category, 'id_category');
        ...
        $this->set('data', $this->delegate->get($id_category, $cod, $name));
     ...
     * @OA\Get(
     *     path="/category/table",
     *     summary="Legge una lista paginata di categorie",
     *     description="Ritorna una lista di categorie filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="category-table",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/category/save",
     *     summary="Salva una categoria",
     *     description="Salva una categoria ne ritorna l'id",
     *     operationId="category-save",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto categoria",
     *         request="category",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Category")
     *     ),
     ...
     * )
     */
    public function save($categoryJson = null, $groupssave = null) {
        parent::evalParam($categoryJson, "category");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($categoryJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     description="Modifica una categoria ne ritorna l'id",
     ...
     * )
     */
    public function edit($id_category = null, $categoryJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_category, "id_category");
        parent::evalParam($categoryJson, "category");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_category, $categoryJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     summary="Rimuove una categoria",
     *     description="Rimuove una categoria dato l'id",
    ...
    public function delete($id_category = null) {
        parent::evalParam($id_category, "id_category");
        $this->set('flag', $this->delegate->delete($id_category));
        $this->responseMessageStatus($this->delegate->status);
    }
}
