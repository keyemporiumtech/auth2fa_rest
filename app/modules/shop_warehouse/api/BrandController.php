...
class BrandController extends AppController {
     ...
     * @OA\Get(
     *     path="/brand/get",
     *     summary="Legge una marca",
     *     description="Ritorna una marca per uno specifico id o per codice o per nome",
     *     operationId="brand-get",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id della marca",
     *         in="query",
     *         name="id_brand",
     *         required=false,
     ...
     * )
     */
    public function get($id_brand = null, $cod = null, $name = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_brand, 'id_brand');
        ...
        $this->set('data', $this->delegate->get($id_brand, $cod, $name));
     ...
     * @OA\Get(
     *     path="/brand/table",
     *     summary="Legge una lista paginata di marce",
     *     description="Ritorna una lista di marce filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="brand-table",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/brand/save",
     *     summary="Salva una marca",
     *     description="Salva una marca ne ritorna l'id",
     *     operationId="brand-save",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto marca",
     *         request="brand",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Brand")
     *     ),
     ...
     * )
     */
    public function save($brandJson = null, $groupssave = null) {
        parent::evalParam($brandJson, "brand");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($brandJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     description="Modifica una marca ne ritorna l'id",
     ...
     *     ),
     *     @OA\Parameter(
     *         description="id della marca da modificare",
     *         in="query",
     *         name="id_brand",
     *         required=false,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function edit($id_brand = null, $brandJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_brand, "id_brand");
        parent::evalParam($brandJson, "brand");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_brand, $brandJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Delete(
     *     path="/brand/delete",
     *     summary="Rimuove una marca",
     *     description="Rimuove una marca dato l'id",
     *     operationId="brand-delete",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id della marca da eliminare",
     *         in="query",
     *         name="id_brand",
     *         required=true,
     *         @OA\Schema(type="integer")
    ...
    public function delete($id_brand = null) {
        parent::evalParam($id_brand, "id_brand");
        $this->set('flag', $this->delegate->delete($id_brand));
        $this->responseMessageStatus($this->delegate->status);
    }
}
