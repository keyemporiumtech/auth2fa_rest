...
class ReservationsettingController extends AppController {

    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new ReservationsettingUI();
    ...
    public function get($id_reservationsetting = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_reservationsetting, 'id_reservationsetting');
        parent::evalParam($cod, 'cod');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_reservationsetting, $cod));
    ...
    public function save($reservationsettingJson = null, $groupssave = null) {
        parent::evalParam($reservationsettingJson, "reservationsetting");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($reservationsettingJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function edit($id_reservationsetting = null, $reservationsettingJson = null, $groupssave = null, $groupsdel = null) {
        ...
        $this->set('value', $this->delegate->edit($id_reservationsetting, $reservationsettingJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function delete($id_reservationsetting = null) {
        parent::evalParam($id_reservationsetting, "id_reservationsetting");
        $this->set('flag', $this->delegate->delete($id_reservationsetting));
        $this->responseMessageStatus($this->delegate->status);
    }
}
