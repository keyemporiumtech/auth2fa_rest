...
class PriceController extends AppController {
     ...
     * @OA\Get(
     *     path="/price/get",
     *     summary="Legge un prezzo",
     *     description="Ritorna un prezzo per uno specifico id o per codice",
     *     operationId="price-get",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del prezzo",
     *         in="query",
     *         name="id_price",
     *         required=false,
     ...
     * )
     */
    public function get($id_price = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_price, 'id_price');
        parent::evalParam($cod, 'cod');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_price, $cod));
     ...
     * @OA\Get(
     *     path="/price/table",
     *     summary="Legge una lista paginata di prezzi",
     *     description="Ritorna una lista di prezzi filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="price-table",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/price/save",
     *     summary="Salva un prezzo",
     *     description="Salva un prezzo ne ritorna l'id",
     *     operationId="price-save",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto prezzo",
     *         request="price",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Price")
     *     ),
     ...
     * )
     */
    public function save($priceJson = null, $groupssave = null) {
        parent::evalParam($priceJson, "price");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($priceJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Put(
     *     path="/price/edit",
     *     summary="Modifica un prezzo",
     *     description="Modifica un prezzo ne ritorna l'id",
     *     operationId="price-edit",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto prezzo",
     ...
     *     ),
     *     @OA\Parameter(
     *         description="id del prezzo da modificare",
     *         in="query",
     *         name="id_price",
     *         required=false,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function edit($id_price = null, $priceJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_price, "id_price");
        parent::evalParam($priceJson, "price");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_price, $priceJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Delete(
     *     path="/price/delete",
     *     summary="Rimuove un prezzo",
     *     description="Rimuove un prezzo dato l'id",
     *     operationId="price-delete",
     *     tags={"shop_warehouse"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del prezzo da eliminare",
     *         in="query",
     *         name="id_price",
     *         required=true,
     *         @OA\Schema(type="integer")
    ...
    public function delete($id_price = null) {
        parent::evalParam($id_price, "id_price");
        $this->set('flag', $this->delegate->delete($id_price));
        $this->responseMessageStatus($this->delegate->status);
    }
}
