...
class FPDF {
    ...
    function RotatedCell($angle, $x, $y, $w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', $fill = false, $link = '') {
        $this->Rotate($angle, $x, $y);
        $this->Cell($w, $h, $txt, $border, $ln, $align, $fill, $link);
        $this->Rotate(0);
    }

    function RotatedText($angle, $x, $y, $txt) {
    ...
    function RotatedImage($angle, $file, $x, $y, $w, $h, $type = '', $link = '') {
