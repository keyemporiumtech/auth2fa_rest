...
/**
 * Riscritto da Giuseppe Sassone per consentire di passare il parametro della root in cui copiare i file generati
 * @param string $fontfile
 * @param string $enc
 * @param string $embed
 */
function MakeFontPath($fontfile, $enc= 'cp1252', $path= null, $embed= true) {
	...
	if (! empty($path)) {
		MakeDefinitionFile($path.$basename . '.php', $type, $enc, $embed, $map, $info);
	} else {
