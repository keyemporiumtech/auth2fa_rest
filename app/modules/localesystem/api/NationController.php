...
class NationController extends AppController {
     ...
     * @OA\Get(
     *     path="/nation/get",
     *     summary="Legge una nazione",
     *     description="Ritorna una nazione per uno specifico id o per codice",
     *     operationId="nation-get",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id della nazione",
     *         in="query",
     *         name="id_nation",
     *         required=false,
     ...
     *     ),
     *     @OA\Parameter(
     *         description="codice della nazione",
     *         in="query",
     *         name="cod",
     *         required=false,
     ...
     *     ),
     *     @OA\Parameter(
     *         description="simbolo della nazione",
     *         in="query",
     *         name="symbol",
     *         required=false,
     *         @OA\Schema(type="string")
     ...
     *         @OA\JsonContent(ref="#/components/schemas/Nation")
     *     ),
     *     @OA\Response(
     *         response="default",
     ...
     * )
     */
    public function get($id_nation = null, $cod = null, $iso = null, $symbol = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_nation, 'id_nation');
        parent::evalParam($cod, 'cod');
        parent::evalParam($iso, 'iso');
        parent::evalParam($symbol, 'symbol');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_nation, $cod, $iso, $symbol));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Get(
     *     path="/nation/getByGeo",
     *     summary="Legge una nazione",
     *     description="Ritorna una nazione per una specifica latitudine e longitudine",
     *     operationId="nation-getByGeo",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="latitudine della nazione",
     *         in="query",
     *         name="lat",
     *         required=true,
     *         @OA\Schema(type="string")
     *     ),
     *     @OA\Parameter(
     *         description="longitudine della nazione",
     *         in="query",
     *         name="lon",
     *         required=true,
     *         @OA\Schema(type="string")
     ...
     * @OA\Get(
     *     path="/nation/table",
     *     summary="Legge una lista paginata di nazione",
     *     description="Ritorna una lista di nazione filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="nation-table",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/nation/save",
     *     summary="Salva una nazione",
     *     description="Salva una nazione ne ritorna l'id",
     *     operationId="nation-save",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto nazione",
     *         request="nation",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Nation")
     *     ),
     ...
     * )
     */
    public function save($nationJson = null, $groupssave = null) {
        parent::evalParam($nationJson, "nation");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($nationJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Put(
     *     path="/nation/edit",
     *     summary="Modifica una nazione",
     *     description="Modifica una nazione ne ritorna l'id",
     *     operationId="nation-edit",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto nazione",
     ...
     * )
     */
    public function edit($id_nation = null, $nationJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_nation, "id_nation");
        parent::evalParam($nationJson, "nation");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_nation, $nationJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Delete(
     *     path="/nation/delete",
     *     summary="Rimuove una nazione",
     *     description="Rimuove una nazione dato l'id",
     *     operationId="nation-delete",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id della nazione da eliminare",
     *         in="query",
     *         name="id_nation",
     *         required=true,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function delete($id_nation = null) {
        parent::evalParam($id_nation, "id_nation");
        $this->set('flag', $this->delegate->delete($id_nation));
        $this->responseMessageStatus($this->delegate->status);
    }
}
