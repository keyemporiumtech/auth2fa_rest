...
class AddressController extends AppController {
    ...
    public function getByStreet($street = null, $number = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($street, 'street');
        parent::evalParam($number, 'number');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->getByStreet($street, $number));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function save($addressJson = null, $groupssave = null) {
        parent::evalParam($addressJson, "address");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($addressJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function edit($id_address = null, $addressJson = null, $groupssave = null, $groupsdel = null) {
        ...
        $this->set('value', $this->delegate->edit($id_address, $addressJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function delete($id_address = null) {
        parent::evalParam($id_address, "id_address");
        $this->set('flag', $this->delegate->delete($id_address));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function tpaddress($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        ...
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpaddress($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }
}
