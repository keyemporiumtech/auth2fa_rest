...
class LanguageController extends AppController {
     ...
     * @OA\Get(
     *     path="/language/get",
     *     summary="Legge una lingua",
     *     description="Ritorna una lingua per uno specifico id o per codice",
     *     operationId="language-get",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id della lingua",
     *         in="query",
     *         name="id_language",
     *         required=false,
     ...
     *     ),
     *     @OA\Parameter(
     *         description="titolo o nome della lingua",
     *         in="query",
     *         name="title",
     *         required=false,
     *         @OA\Schema(type="string")
     *     ),
     *     @OA\Parameter(
     *         description="simbolo della lingua",
     *         in="query",
     *         name="symbol",
     *         required=false,
     *         @OA\Schema(type="string")
     ...
     * )
     */
    public function get($id_language = null, $cod = null, $title = null, $symbol = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_language, 'id_language');
        ...
        $this->set('data', $this->delegate->get($id_language, $cod, $title, $symbol));
     ...
     * @OA\Get(
     *     path="/language/table",
     *     summary="Legge una lista paginata di lingue",
     *     description="Ritorna una lista di lingue filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="language-table",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/language/save",
     *     summary="Salva una lingua",
     *     description="Salva una lingua ne ritorna l'id",
     *     operationId="language-save",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto lingua",
     *         request="language",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Language")
     *     ),
     ...
     * )
     */
    public function save($languageJson = null, $groupssave = null) {
        parent::evalParam($languageJson, "language");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($languageJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Put(
     *     path="/language/edit",
     *     summary="Modifica una lingua",
     *     description="Modifica una lingua ne ritorna l'id",
     *     operationId="language-edit",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto lingua",
     ...
     * )
     */
    public function edit($id_language = null, $languageJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_language, "id_language");
        parent::evalParam($languageJson, "language");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_language, $languageJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     summary="Rimuove una lingua",
     *     description="Rimuove una lingua dato l'id",
     *     operationId="language-delete",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id della lingua da eliminare",
     *         in="query",
     *         name="id_language",
     *         required=true,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function delete($id_language = null) {
        parent::evalParam($id_language, "id_language");
        $this->set('flag', $this->delegate->delete($id_language));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Post(
     *     path="/language/setup",
     *     summary="Imposta una lingua a sistema",
     *     description="Imposta una lingua come riferimento di sistema e ne ritorna l'oggetto",
     *     operationId="language-setup",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="codice della lingua da settare",
     *         in="query",
     *         name="cod",
     *         required=false,
     *         @OA\Schema(type="string")
    ...
    public function setup($cod = null) {
        parent::evalParam($cod, 'cod');
        $this->set('data', $this->delegate->setupLanguage($cod));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     summary="Legge la lingua impostata a sistema",
     *     description="Ritorna la lingua di riferimento impostata a sistema",
     *     operationId="language-current",
     *     tags={"localesystem"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="Lista delle foreign keys richieste",
    ...
    public function current($belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->getCurrentLanguageSystem());
        $this->responseMessageStatus($this->delegate->status);
    }
}
