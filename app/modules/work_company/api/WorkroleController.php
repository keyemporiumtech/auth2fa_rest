...
class WorkroleController extends AppController {

    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new WorkroleUI();
     ...
     * @OA\Get(
     *     path="/workrole/get",
     *     summary="Legge un ruolo",
     *     description="Ritorna un ruolo per uno specifico id o per codice",
     *     operationId="workrole-get",
     *     tags={"work_company"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     *         @OA\JsonContent(ref="#/components/schemas/Workrole")
     *     ),
     *     @OA\Response(
     *         response="default",
     ...
     * )
     */
    public function get($id_workrole = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_workrole, 'id_workrole');
        parent::evalParam($cod, 'cod');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_workrole, $cod));
     ...
     * @OA\Get(
     *     path="/workrole/table",
     *     summary="Legge una lista paginata di ruoli",
     *     description="Ritorna una lista di ruoli filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="workrole-table",
     *     tags={"work_company"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     *         @OA\Schema(
     *             type="array",
     *             @OA\Items(ref="#/components/schemas/Workrole")
     *         )
     *     ),
     *     @OA\Response(
     *         response="default",
     ...
     * @OA\Post(
     *     path="/workrole/save",
     *     summary="Salva un ruolo",
     *     description="Salva un ruolo ne ritorna l'id",
     *     operationId="workrole-save",
     *     tags={"work_company"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto ruolo",
     *         request="workrole",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Workrole")
     *     ),
     ...
     * )
     */
    public function save($workroleJson = null, $groupssave = null) {
        parent::evalParam($workroleJson, "workrole");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($workroleJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Put(
     *     path="/workrole/edit",
     *     summary="Modifica un ruolo",
     *     description="Modifica un ruolo ne ritorna l'id",
     *     operationId="workrole-edit",
     *     tags={"work_company"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto ruolo",
     ...
     *     ),
     *     @OA\Parameter(
     *         description="id del ruolo da modificare",
     *         in="query",
     *         name="id_workrole",
     *         required=false,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function edit($id_workrole = null, $workroleJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_workrole, "id_workrole");
        parent::evalParam($workroleJson, "workrole");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_workrole, $workroleJson));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Delete(
     *     path="/workrole/delete",
     *     summary="Rimuove un ruolo",
     *     description="Rimuove un ruolo dato l'id",
     *     operationId="workrole-delete",
     *     tags={"work_company"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del ruolo da eliminare",
     *         in="query",
     *         name="id_workrole",
     *         required=true,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function delete($id_workrole = null) {
        parent::evalParam($id_workrole, "id_workrole");
        $this->set('flag', $this->delegate->delete($id_workrole));
        $this->responseMessageStatus($this->delegate->status);
    }
}
