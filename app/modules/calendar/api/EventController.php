...
class EventController extends AppController {
    ...
    public function save($eventJson = null, $groupssave = null) {
        parent::evalParam($eventJson, "event");
        parent::completeFkVf($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($eventJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function edit($id_event = null, $eventJson = null, $groupssave = null, $groupsdel = null) {
        ...
        $this->set('value', $this->delegate->edit($id_event, $eventJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function delete($id_event = null) {
        parent::evalParam($id_event, "id_event");
        $this->set('flag', $this->delegate->delete($id_event));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function tpevent($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        ...
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpevent($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }
}
