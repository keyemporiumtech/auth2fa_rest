...
class EventattachmentController extends AppController {

    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new EventattachmentUI();
    ...
    public function save($eventattachmentJson = null, $groupssave = null) {
        parent::evalParam($eventattachmentJson, "eventattachment");
        parent::completeFkVf($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($eventattachmentJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function edit($id_eventattachment = null, $eventattachmentJson = null, $groupssave = null, $groupsdel = null) {
        ...
        $this->set('value', $this->delegate->edit($id_eventattachment, $eventattachmentJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function delete($id_eventattachment = null) {
        parent::evalParam($id_eventattachment, "id_eventattachment");
        $this->set('flag', $this->delegate->delete($id_eventattachment));
        $this->responseMessageStatus($this->delegate->status);
    }
}
