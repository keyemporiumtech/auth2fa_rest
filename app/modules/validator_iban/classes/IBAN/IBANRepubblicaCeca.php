...
class IBANRepubblicaCeca extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->bankorg = substr($iban, 8, 6);
        $obj->labelorg_cod = EnumIBANOrg::FRONT_OFFICE;
        $obj->cc = substr($iban, 14, 10);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-4|bankorg-8-6|cc-14-10";
        $obj->length = $LEN;
