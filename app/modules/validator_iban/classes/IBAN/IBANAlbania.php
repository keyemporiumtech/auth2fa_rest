...
class IBANAlbania extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->cin = substr($iban, 11, 1);
        $obj->cc = substr($iban, 12, 16);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-3|bankorg-7-4|cin-11-1|cc-12-16";
        $obj->length = $LEN;
        $obj->bban = $obj->bankcod . $obj->bankorg . $obj->cin . $obj->cc;
