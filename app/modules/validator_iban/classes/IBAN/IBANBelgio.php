...
class IBANBelgio extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->cc = substr($iban, 7, 7);
        $obj->controlcod = substr($iban, 14, 2);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-3|cc-7-7|controlcod-14-2";
        $obj->length = $LEN;
