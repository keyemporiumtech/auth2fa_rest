...
class IBANSpagna extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->controlkey = substr($iban, 12, 2);
        $obj->cc = substr($iban, 14, 10);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-4|bankorg-8-4|controlkey-12-2|cc-14-10";
        $obj->length = $LEN;
