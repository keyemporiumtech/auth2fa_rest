...
class IBANEstonia extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->bankorg = substr($iban, 6, 2);
        $obj->labelorg_cod = EnumIBANOrg::AGENCY;
        $obj->cc = substr($iban, 8, 11);
        $obj->controlkey = substr($iban, 19, 1);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-2|bankorg-6-2|cc-8-11|controlkey-19-1";
        $obj->length = $LEN;
