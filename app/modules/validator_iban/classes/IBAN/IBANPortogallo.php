...
class IBANPortogallo extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->bankcod = substr($iban, 4, 8);
        $obj->cc = substr($iban, 12, 11);
        $obj->controlkey = substr($iban, 23, 2);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-8|cc-12-11|controlkey-23-2";
        $obj->length = $LEN;
