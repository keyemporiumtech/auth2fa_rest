...
class IBANCroazia extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->bankcod = substr($iban, 4, 7);
        $obj->cc = substr($iban, 11, 10);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-7|cc-11-10";
        $obj->length = $LEN;
