...
class IBANUngheria extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->cc = substr($iban, 12, 15);
        $obj->controlkey2 = substr($iban, 27, 1);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-3|bankorg-7-4|controlkey-11-1|cc-12-15|controlkey2-27-1";
        $obj->length = $LEN;
        $obj->bban = $obj->bankcod . $obj->bankorg . $obj->controlkey . $obj->cc . $obj->controlkey2;
