...
class IBANMontenegro extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->cc = substr($iban, 7, 13);
        $obj->controlkey = substr($iban, 20, 2);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-3|cc-7-13|controlkey-20-2";
        $obj->length = $LEN;
