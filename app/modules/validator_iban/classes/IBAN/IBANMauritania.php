...
class IBANMauritania extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->bankorg = substr($iban, 9, 5);
        $obj->labelorg_cod = EnumIBANOrg::GUICHET;
        $obj->cc = substr($iban, 14, 11);
        $obj->controlkey = substr($iban, 25, 2);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-5|bankorg-9-5|cc-14-11|controlkey-25-2";
        $obj->length = $LEN;
