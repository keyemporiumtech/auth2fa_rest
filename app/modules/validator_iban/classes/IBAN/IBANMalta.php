...
class IBANMalta extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->bankorg = substr($iban, 8, 5);
        $obj->labelorg_cod = EnumIBANOrg::FRONT_OFFICE;
        $obj->cc = substr($iban, 13, 18);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-4|bankorg-8-5|cc-13-18";
        $obj->length = $LEN;
