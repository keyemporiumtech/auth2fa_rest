...
class IBANBulgaria extends IBANGeneric {
    ...
    static function converter($iban) {
        ...
        $obj->controlcod = substr($iban, 12, 2);
        $obj->cc = substr($iban, 14, 8);
        $obj->pattern = "cod_iso3166-0-2|controlnumbers-2-2|bankcod-4-4|bankcod-8-4|controlcod-12-2|cc-14-8";
        $obj->length = $LEN;
        $obj->bban = $obj->bankcod . $obj->bankorg . $obj->controlcod . $obj->cc;
