...
class AttachmentController extends AppController {
    ...
    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new AttachmentUI();
     ...
     *     description="Ritorna un allegato per uno specifico id o per nome o per codice",
     ...
     *     ),
     *     @OA\Parameter(
     *         description="codice dell'allegato",
     *         in="query",
     *         name="cod",
     *         required=false,
     ...
     * )
     */
    public function get($id_attachment = null, $cod = null, $name = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_attachment, 'id_attachment');
        ...
        $this->set('data', $this->delegate->get($id_attachment, $cod, $name));
     ...
     * )
     */
    public function save($attachmentJson = null, $groupssave = null) {
        parent::evalParam($attachmentJson, "attachment");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($attachmentJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     ),
     *     @OA\Parameter(
     *         description="id allegato da modificare",
     *         in="query",
     *         name="id_attachment",
     *         required=false,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function edit($id_attachment = null, $attachmentJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_attachment, "id_attachment");
        parent::evalParam($attachmentJson, "attachment");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_attachment, $attachmentJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * )
     */
    public function delete($id_attachment = null) {
        parent::evalParam($id_attachment, "id_attachment");
        $this->set('flag', $this->delegate->delete($id_attachment));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    /**
     * @OA\Get(
     *     path="/attachment/tpattachment",
     *     summary="Legge una lista paginata di tipi di allegati",
     *     description="Ritorna una lista di tipi di allegati filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="attachment-tpattachment",
     *     tags={"typological"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="Lista delle condizioni di filtro",
     ...
     * )
     */
    public function tpattachment($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($jsonFilters, 'filters');
        parent::evalParam($jsonOrders, 'orders');
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpattachment($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }
}