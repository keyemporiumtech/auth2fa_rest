...
class GroupController extends AppController {
     ...
     * @OA\Get(
     *     path="/group/get",
     *     summary="Legge un gruppo",
     *     description="Ritorna un gruppo per uno specifico id o per codice",
     ...
     * )
     */
    public function get($id_group = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        ...
        $this->set('data', $this->delegate->get($id_group, $cod));
     ...
     * @OA\Get(
     *     path="/group/table",
     *     summary="Legge una lista paginata di gruppi",
     *     description="Ritorna una lista di gruppi filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="group-table",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * @OA\Post(
     *     path="/group/save",
     *     summary="Salva un gruppo",
     *     description="Salva un gruppo ne ritorna l'id",
     *     operationId="group-save",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     ...
     * )
     */
    public function save($groupJson = null, $groupssave = null) {
        parent::evalParam($groupJson, "group");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($groupJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     description="Modifica un gruppo ne ritorna l'id",
     ...
     * )
     */
    public function edit($id_group = null, $groupJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_group, "id_group");
        parent::evalParam($groupJson, "group");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_group, $groupJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     * @OA\Delete(
     *     path="/group/delete",
     *     summary="Rimuove un gruppo",
     *     description="Rimuove un gruppo dato l'id",
    ...
    public function delete($id_group = null) {
        parent::evalParam($id_group, "id_group");
        $this->set('flag', $this->delegate->delete($id_group));
        $this->responseMessageStatus($this->delegate->status);
    }
}
