...
class ActivityrelationController extends AppController {

    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new ActivityrelationUI();
    ...
    public function save($activityrelationJson = null, $groupssave = null) {
        parent::evalParam($activityrelationJson, "activityrelation");
        parent::completeFkVf($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($activityrelationJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function edit($id_activityrelation = null, $activityrelationJson = null, $groupssave = null, $groupsdel = null) {
        ...
        $this->set('value', $this->delegate->edit($id_activityrelation, $activityrelationJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function delete($id_activityrelation = null) {
        parent::evalParam($id_activityrelation, "id_activityrelation");
        $this->set('flag', $this->delegate->delete($id_activityrelation));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function tpactivityrelation($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        ...
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpactivityrelation($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }
