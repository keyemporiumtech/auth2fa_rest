...
class ContactreferenceController extends AppController {

    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new ContactreferenceUI();
     ...
     * )
     */
    public function get($id_contactreference = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_contactreference, 'id_contactreference');
        parent::evalParam($cod, 'cod');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_contactreference, $cod));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Get(
     *     path="/contactreference/table",
     ...
     *     operationId="contactreference-table",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * )
     */
    public function save($contactreferenceJson = null, $groupssave = null) {
        parent::evalParam($contactreferenceJson, "contactreference");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($contactreferenceJson));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Put(
     *     path="/contactreference/edit",
     *     summary="Modifica un contatto",
     *     description="Modifica un contatto ne ritorna l'id",
     *     operationId="contactreference-edit",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto contatto",
     ...
     * )
     */
    public function edit($id_contactreference = null, $contactreferenceJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_contactreference, "id_contactreference");
        parent::evalParam($contactreferenceJson, "contactreference");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_contactreference, $contactreferenceJson));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Delete(
     *     path="/contactreference/delete",
     *     summary="Rimuove un contatto",
     *     description="Rimuove un contatto dato l'id",
     *     operationId="contactreference-delete",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     * )
     */
    public function delete($id_contactreference = null) {
        parent::evalParam($id_contactreference, "id_contactreference");
        $this->set('flag', $this->delegate->delete($id_contactreference));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    /**
     * @OA\Get(
     *     path="/contactreference/tpcontactreference",
     *     summary="Legge una lista paginata di tipi di contatti",
     *     description="Ritorna una lista di tipi di contatti filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="contactreference-tpcontactreference",
     *     tags={"typological"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="Lista delle condizioni di filtro",
     ...
     * )
     */
    public function tpcontactreference($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($jsonFilters, 'filters');
        parent::evalParam($jsonOrders, 'orders');
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpcontactreference($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }

    /**
     * @OA\Get(
     *     path="/contactreference/tpsocialreference",
     *     summary="Legge una lista paginata di tipi di contatti social",
     *     description="Ritorna una lista di tipi di contatti social filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="contactreference-tpsocialreference",
     *     tags={"typological"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="Lista delle condizioni di filtro",
     ...
     * )
     */
    public function tpsocialreference($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($jsonFilters, 'filters');
        parent::evalParam($jsonOrders, 'orders');
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpsocialreference($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }
}
