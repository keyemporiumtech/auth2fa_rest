...
class PermissionController extends AppController {
    ...
    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new PermissionUI();
     ...
     * @OA\Get(
     *     path="/permission/get",
     *     summary="Legge un permesso utente",
     *     description="Ritorna un permesso utente per uno specifico id o per codice",
     *     operationId="permission-get",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del permesso utente",
     *         in="query",
     *         name="id_permission",
     *         required=false,
     ...
     *     ),
     *     @OA\Parameter(
     *         description="codice del permesso utente",
     *         in="query",
     *         name="cod",
     *         required=false,
     ...
     * )
     */
    public function get($id_permission = null, $cod = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        parent::evalParam($id_permission, 'id_permission');
        parent::evalParam($cod, 'cod');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->get($id_permission, $cod));
     ...
     *     summary="Legge una lista paginata di permesso utenti",
     *     description="Ritorna una lista di permesso utenti filtrata, ordinata e paginata in base ai parametri di ricerca passati",
     *     operationId="permission-table",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\Parameter(
     ...
     *     summary="Salva un permesso utente",
     *     description="Salva un permesso utente ne ritorna l'id",
     *     operationId="permission-save",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto permesso utente",
     *         request="permission",
     *         required=true,
     *         @OA\JsonContent(ref="#/components/schemas/Permission")
     *     ),
     ...
     * )
     */
    public function save($permissionJson = null, $groupssave = null) {
        parent::evalParam($permissionJson, "permission");
        parent::completeFkVfSave($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($permissionJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     summary="Modifica un permesso utente",
     *     description="Modifica un permesso utente ne ritorna l'id",
     *     operationId="permission-edit",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\RequestBody(
     *         description="oggetto permesso utente",
     ...
     *     ),
     *     @OA\Parameter(
     *         description="id del permesso utente da modificare",
     *         in="query",
     *         name="id_permission",
     *         required=false,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function edit($id_permission = null, $permissionJson = null, $groupssave = null, $groupsdel = null) {
        parent::evalParam($id_permission, "id_permission");
        parent::evalParam($permissionJson, "permission");
        parent::completeFkVfSave($this->delegate, $groupssave, $groupsdel);
        $this->set('value', $this->delegate->edit($id_permission, $permissionJson));
        $this->responseMessageStatus($this->delegate->status);
    }
     ...
     *     summary="Rimuove un permesso utente",
     *     description="Rimuove un permesso utente dato l'id",
     *     operationId="permission-delete",
     *     tags={"authentication"},
     *     deprecated=false,
     *     @OA\Parameter(
     *         description="id del permesso utente da eliminare",
     *         in="query",
     *         name="id_permission",
     *         required=true,
     *         @OA\Schema(type="integer")
     ...
     * )
     */
    public function delete($id_permission = null) {
        parent::evalParam($id_permission, "id_permission");
        $this->set('flag', $this->delegate->delete($id_permission));
        $this->responseMessageStatus($this->delegate->status);
    }
}
