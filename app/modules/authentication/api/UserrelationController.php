...
class UserrelationController extends AppController {

    public function beforeFilter() {
        $this->json = true;
        $this->delegate = new UserrelationUI();
    ...
    public function save($userrelationJson = null, $groupssave = null) {
        parent::evalParam($userrelationJson, "userrelation");
        parent::completeFkVf($this->delegate, $groupssave);
        $this->set('value', $this->delegate->save($userrelationJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function edit($id_userrelation = null, $userrelationJson = null, $groupssave = null, $groupsdel = null) {
        ...
        $this->set('value', $this->delegate->edit($id_userrelation, $userrelationJson));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function delete($id_userrelation = null) {
        parent::evalParam($id_userrelation, "id_userrelation");
        $this->set('flag', $this->delegate->delete($id_userrelation));
        $this->responseMessageStatus($this->delegate->status);
    }
    ...
    public function tpuserrelation($jsonFilters = null, $jsonOrders = null, $jsonPaginate = null, $belongs = null, $virtualfields = null, $flags = null, $properties = null, $groups = null, $likegroups = null) {
        ...
        parent::evalParam($jsonPaginate, 'paginate');
        parent::completeFkVf($this->delegate, $belongs, $virtualfields, $flags, $properties, $groups, $likegroups);
        $this->set('data', $this->delegate->tpuserrelation($jsonFilters, $jsonOrders, $jsonPaginate));
        $this->responseMessageStatus($this->delegate->status);
    }
}
