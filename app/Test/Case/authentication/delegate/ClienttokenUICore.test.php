<?php
App::uses("ClienttokenUI", "modules/authentication/delegate");
App::uses("ClienttokenBS", "modules/authentication/business");
App::uses("MysqlUtilityTest", "Test/utility");

class ClienttokenUICoreTest extends CakeTestCase {
    ...
    public function testTable() {
        ...
        $this->assertEquals($paginator['list'][0]['Clienttoken']['id'], 1);
        $this->removeRecord($autoIncrement);
    }
